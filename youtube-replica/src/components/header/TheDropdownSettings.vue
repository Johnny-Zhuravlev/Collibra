<template>
  <div
    class="hidden w-48 sm:w-72 py-2 absolute top-9 right-0 bg-white rounded-md shadow-md group-hover:block"
  >
      ...
      <ul>
        <li>
          ...
          >
            ...
            <span class="inline-block mr-auto"> Appearance: Device theme </span>
        ...
        <li>
          ...
          >
            ...
            <span class="inline-block mr-auto"> Location: Costa-Rica </span>
            <span class="flex text-gray-500">
              <svg
                class="w-4 sm:w-5 h-4 sm:h-5"
                xmlns="http://www.w3.org/2000/svg"
    ...
    <section class="pt-2">
      <ul>
        <li>
          <a
            href="/"
            class="flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100"
          >
